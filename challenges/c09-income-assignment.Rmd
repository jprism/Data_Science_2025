...
-   Document your observations here.
    ...
    -   3 person families are similar with some counties have them an extra 10-20k
    -   4, 5, and 6 person families have much wider ranges
    -   The widest confidence interval is 5 person families for Nantucket, with the confidence interval covering over 200k in median household income
    -   The median household income for 2 person families seems to be the smallest and generally the median value increases with family size
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   No there is a lot of overlap of the different lines and some of the colors are very similar, like green and blue
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   There seems to be a roughly sharp exponential relationship between SE and population where SE decreases as population increase. This makes sense as you require a high enough population to ensure you median isn't being heavily influenced by the normal variation seen from the standard deviation of the data. This is supported by the trend line looking close to linear when log scales are used on the x and y axis.
-   What does this *overall* trend tell you about the relative ease of studying small vs large counties?
    -   It's likely for more easy to make conclusive claims about larger counties with confidence.
...
-   rhode island, new jersey, connecticut and massachussets have the highest household incomes, specifically for 4,5, and 6 person families.
-   New york where I'm from is pretty unremarkable in terms of incomes, it doesn't have the lowest or the highest and has moderate spread between family size and incomes.
